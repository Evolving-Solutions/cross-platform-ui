...
// app color palette
class Palette {
  static Color primaryTeal = const Color.fromRGBO(0, 183, 195, 1);
  static Color primaryCasal = const Color.fromRGBO(47, 93, 102, 1);
  ...
  static Color carol2 = const Color(0xFFFFb6AE);
}
